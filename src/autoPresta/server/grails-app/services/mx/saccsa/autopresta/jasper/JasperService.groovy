 ...
 */
 ...
 package mx.saccsa.autopresta.jasper

import grails.gorm.transactions.Transactional
import groovy.sql.Sql
import mx.saccsa.plugins.jasper.JasperExportFormat
import mx.saccsa.plugins.jasper.JasperReportDef
...
class JasperService {
     ...
     * @return reportDef
     */
    JasperReportDef buildReportDefinition(Map parameters, Locale locale, Map testModel) {
    ...
    private Collection getReportData(testModel, parameters) {
        ...
        if (testModel?.data) {
            try {
                ...
                e.printStackTrace()
                throw new Exception("Expected chainModel.data parameter to be a Collection, but it was", e)
            }
        } else {
